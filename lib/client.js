...
(function() {
  ...
  Client = (function() {
    ...
    function Client(company, product, options, default_options, extra_options_list) {
      ...
      this.load_from_config(company, product, options.config);
      this.load_from_config(company, product, process.env[company.toUpperCase() + '_' + product.toUpperCase() + '_CONFIG']);
      this.load_from_config(company, product, process.env[company.toUPperCase() + '_CONFIG']);
